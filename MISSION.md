...
ZitPit exists to break the direct trust path between autonomous builders and the public internet.

AI agents move too quickly for manual review to be the primary control. When they fetch a package, open a repo, or trigger a build step, that is an execution decision and should be treated as one.
